...
document.getElementById('loginForm').addEventListener('submit', async (e) => {
    ...
    try {
        ...
        errorDiv.textContent = erro.message || 'Erro ao fazer login. Verifique suas credenciais.';
        errorDiv.style.display = 'block';
    }
...
async function carregarDashboard() {
    try {
        ...
        document.getElementById('recentReservas').innerHTML = 
            '<p class="error-message">Erro ao carregar dados do dashboard</p>';
    }
}
...
async function carregarReservas() {
    ...
    try {
        ...
        container.innerHTML = '<p class="error-message">Erro ao carregar reservas</p>';
    }
}
...
document.getElementById('formEditarChale').addEventListener('submit', async (e) => {
    ...
    try {
        ...
        alert('Erro ao salvar chalé: ' + erro.message);
    }
});
